...
describe('HeadlinesList Styling Tests', () => {
    ...
    it('should apply proper overflow constraints to table container', () => {
        ...
        const overflowContainer = container.querySelector('.overflow-x-auto.overflow-y-auto.max-w-full.max-h-\\[80vh\\].min-w-0');
    ...
    it('should render table within overflow container', () => {
        ...
        const overflowContainer = container.querySelector('.overflow-x-auto.overflow-y-auto');
